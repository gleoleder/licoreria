...
function getUser() {
  return {
    email: localStorage.getItem('pos_user_email') || 'desconocido',
    name:  localStorage.getItem('pos_user_name')  || 'desconocido'
  };
}

// ═══════════════════════════════════════════════════════
//  AUTH — Login con Google + usuarios desde Google Sheets
// ═══════════════════════════════════════════════════════
...
function setupLoginScreen() {
  ...
  // Un solo popup OAuth → da correo + acceso a Sheets a la vez
