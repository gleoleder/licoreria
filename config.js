...
// ═══════════════════════════════════════════════════════
//
//  SHEETS_ID      → ID del Google Sheet (fuente de verdad)
...
//
//  SHEETS_URL     → URL del Apps Script Web App (para escritura)
...
// Los usuarios autorizados se gestionan directamente en Google Sheets
// pestaña "Usuarios": columna A = Email | B = Nombre | C = Activo (si/no)
